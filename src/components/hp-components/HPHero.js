    ...
    <Container className="position-relative">
      <div className="w-40 pr-2">
        <h1 style={{ color: props.colors.main }}>
          DRN – a building where Dreams are Real & Never - ending. A building
          that exceeds your expectations.
        </h1>
        <p style={{ color: props.colors.light }}>
          Representing a premium multi – functional hub in the heart of Prague.
          The Czech architectural masterpiece combining a modern building and
          historical baroque - renaissance palace.
        </p>
